  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex items-center justify-center px-6">
      ...
      <div className="max-w-sm w-full">
        ...
        {sent ? (
          <>
            <p className="text-sm text-slate-700 dark:text-slate-300 mb-6">If that email has an account, a reset link is on its way. Check your inbox (and spam).</p>
            <Link to="/login" className="text-sm text-teal-600 dark:text-teal-400 underline">Back to login</Link>
          </>
        ) : (
          <>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-8">Enter your email and we'll send a reset link.</p>
            ...
            <p className="text-sm text-slate-500 mt-6"><Link to="/login" className="text-teal-600 dark:text-teal-400 underline">Back to login</Link></p>
          </>
        )}
      </div>
    </div>
